...
public interface NCoVRepository extends ReactiveCrudRepository<NCoVEntity, String> {
    ...
    @Query(
        "SELECT T1.DPRT_NAM, T2.ON_CNT_I, T2.OFF_CNT_I, T2.LEAVE_CNT_I, T2.ON_CNT_E, T2.OFF_CNT_E, T2.LEAVE_CNT_E " +
    ...
    @Query(
        "SELECT T1.DPRT_NAM, T1.GRP_NAM, T2.ON_CNT_I, T2.OFF_CNT_I, T2.LEAVE_CNT_I, T2.ON_CNT_E, T2.OFF_CNT_E, T2.LEAVE_CNT_E " +
