...
public interface NCoVRepository extends ReactiveCrudRepository<NCoVEntity, String> {
    ...
    @Query("""
        ...
        ( \
            SELECT T1.DPRT_NAM, \
                IFNULL(T2.ON_CNT_I, 0) AS ON_CNT_I, IFNULL(T2.OFF_CNT_I, 0) AS OFF_CNT_I, IFNULL(T2.LEAVE_CNT_I, 0) AS LEAVE_CNT_I, IFNULL(T2.AWAY_CNT_I, 0) AS AWAY_CNT_I, IFNULL(T2.TEMP_CNT_I, 0) AS TEMP_CNT_I, IFNULL(T2.GRAY_CNT_I, 0) AS GRAY_CNT_I, \
                IFNULL(T2.ON_CNT_E, 0) AS ON_CNT_E, IFNULL(T2.OFF_CNT_E, 0) AS OFF_CNT_E, IFNULL(T2.LEAVE_CNT_E, 0) AS LEAVE_CNT_E, IFNULL(T2.AWAY_CNT_E, 0) AS AWAY_CNT_E, IFNULL(T2.TEMP_CNT_E, 0) AS TEMP_CNT_E, IFNULL(T2.GRAY_CNT_E, 0) AS GRAY_CNT_E, \
                IFNULL(T2.ON_CNT_V, 0) AS ON_CNT_V, IFNULL(T2.OFF_CNT_V, 0) AS OFF_CNT_V, IFNULL(T2.LEAVE_CNT_V, 0) AS LEAVE_CNT_V, IFNULL(T2.AWAY_CNT_V, 0) AS AWAY_CNT_V, IFNULL(T2.TEMP_CNT_V, 0) AS TEMP_CNT_V, IFNULL(T2.GRAY_CNT_V, 0) AS GRAY_CNT_V \
