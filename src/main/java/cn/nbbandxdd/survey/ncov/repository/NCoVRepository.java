    ...
    @Query("""
        ( \
            SELECT '天津研发部' AS DPRT_NAM, \
                ...
                IFNULL(SUM(CASE WHEN Q01 LIKE '2.阳康到岗%' AND FLAG = 'I' THEN 1 ELSE 0 END), 0) AS ON_POS_CNT_I, \
                IFNULL(SUM(CASE WHEN Q01 NOT LIKE '%到岗%' AND FLAG = 'I' THEN 1 ELSE 0 END), 0) AS OFF_CNT_I, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '3.请假%' AND FLAG = 'I' THEN 1 ELSE 0 END), 0) AS LEAVE_CNT_I, \
                IFNULL(SUM(CASE WHEN Q01 = '4.核酸/抗原阳性' AND FLAG = 'I' THEN 1 ELSE 0 END), 0) AS POS_CNT_I, \
                IFNULL(SUM(CASE WHEN Q01 = '5.疑似症状' AND FLAG = 'I' THEN 1 ELSE 0 END), 0) AS SUS_CNT_I, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '%到岗%' AND FLAG = 'E' THEN 1 ELSE 0 END), 0) AS ON_CNT_E, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '2.阳康到岗%' AND FLAG = 'E' THEN 1 ELSE 0 END), 0) AS ON_POS_CNT_E, \
                IFNULL(SUM(CASE WHEN Q01 NOT LIKE '%到岗%' AND FLAG = 'E' THEN 1 ELSE 0 END), 0) AS OFF_CNT_E, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '3.请假%' AND FLAG = 'E' THEN 1 ELSE 0 END), 0) AS LEAVE_CNT_E, \
                IFNULL(SUM(CASE WHEN Q01 = '4.核酸/抗原阳性' AND FLAG = 'E' THEN 1 ELSE 0 END), 0) AS POS_CNT_E, \
                IFNULL(SUM(CASE WHEN Q01 = '5.疑似症状' AND FLAG = 'E' THEN 1 ELSE 0 END), 0) AS SUS_CNT_E, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '%到岗%' AND FLAG = 'V' THEN 1 ELSE 0 END), 0) AS ON_CNT_V, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '2.阳康到岗%' AND FLAG = 'V' THEN 1 ELSE 0 END), 0) AS ON_POS_CNT_V, \
                IFNULL(SUM(CASE WHEN Q01 NOT LIKE '%到岗%' AND FLAG = 'V' THEN 1 ELSE 0 END), 0) AS OFF_CNT_V, \
                IFNULL(SUM(CASE WHEN Q01 LIKE '3.请假%' AND FLAG = 'V' THEN 1 ELSE 0 END), 0) AS LEAVE_CNT_V, \
                IFNULL(SUM(CASE WHEN Q01 = '4.核酸/抗原阳性' AND FLAG = 'V' THEN 1 ELSE 0 END), 0) AS POS_CNT_V, \
                IFNULL(SUM(CASE WHEN Q01 = '5.疑似症状' AND FLAG = 'V' THEN 1 ELSE 0 END), 0) AS SUS_CNT_V \
            FROM NCoV WHERE DPRT_NAM IN ('天研开发一部', '天研开发二部', '天研应用平台研发部', '天研测试部', '天研综合管理部') \
        ) \
            UNION ALL \
        ( \
            SELECT T1.DPRT_NAM, \
                IFNULL(T2.ON_CNT_I, 0) AS ON_CNT_I, IFNULL(T2.ON_POS_CNT_I, 0) AS ON_POS_CNT_I, IFNULL(T2.OFF_CNT_I, 0) AS OFF_CNT_I, IFNULL(T2.LEAVE_CNT_I, 0) AS LEAVE_CNT_I, IFNULL(T2.POS_CNT_I, 0) AS POS_CNT_I, IFNULL(T2.SUS_CNT_I, 0) AS SUS_CNT_I, \
                IFNULL(T2.ON_CNT_E, 0) AS ON_CNT_E, IFNULL(T2.ON_POS_CNT_E, 0) AS ON_POS_CNT_E, IFNULL(T2.OFF_CNT_E, 0) AS OFF_CNT_E, IFNULL(T2.LEAVE_CNT_E, 0) AS LEAVE_CNT_E, IFNULL(T2.POS_CNT_E, 0) AS POS_CNT_E, IFNULL(T2.SUS_CNT_E, 0) AS SUS_CNT_E, \
                IFNULL(T2.ON_CNT_V, 0) AS ON_CNT_V, IFNULL(T2.ON_POS_CNT_V, 0) AS ON_POS_CNT_V, IFNULL(T2.OFF_CNT_V, 0) AS OFF_CNT_V, IFNULL(T2.LEAVE_CNT_V, 0) AS LEAVE_CNT_V, IFNULL(T2.POS_CNT_V, 0) AS POS_CNT_V, IFNULL(T2.SUS_CNT_V, 0) AS SUS_CNT_V \
